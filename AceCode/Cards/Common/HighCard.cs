...
// Deal damage and flip up to 2 white cards.
public class HighCard() : AceWhiteCard(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy), IFlipCard
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay play)
    {
        ...
        await Task.Delay((int)(0.2f * 1000f));
        await Ace.AceCode.Mechanics.Flip.Color(choiceContext, this, play, AceColor.White, 0, 2);
    }
